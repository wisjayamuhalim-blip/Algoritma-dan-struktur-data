...
root.configure(background="#71a100")
tk.Wm.wm_title(root, "Tic Tac Toe muh alim wisjaya D0425327")
...
def win():
    ...
    if x1 and x2 and x3 != "":
        if x1 == x2 == x3:
            wint.set(" pemenang "+str(x1))

    if y1 and y2 and y3 != "":
        if y1 == y2 == y3:
            wint.set(" pemenang "+str(y1))
    if z1 and z2 and z3 != "":
        if z1 == z2 == z3:
            wint.set(" pemenang "+str(z1))
    ...
    if x2 and y2 and z2 != "":
        if x2 == y2 == z2:
            wint.set(" pemenang "+str(x2))
    if x3 and y3 and z3 != "":
        if x3 == y3 == z3:
            wint.set(" pemenang "+str(x3))
